...
protocol OnProgressScreenModelProtocol: AnyObject {
...
// MARK: - OnProgressScreenModel

final class OnProgressScreenModel: NSObject {
...
// MARK: - OnProgressScreenModelProtocol

extension OnProgressScreenModel: OnProgressScreenModelProtocol {
    func setupFetchedResultsController(searchText: String = "") {
...
extension OnProgressScreenModel: NSFetchedResultsControllerDelegate {
...
extension OnProgressScreenModel: WipeStorageDelegate {
    func storageWiped() {
        setupFetchedResultsController()
    }
}
